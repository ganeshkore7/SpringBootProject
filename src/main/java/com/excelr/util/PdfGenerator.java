...
public class PdfGenerator {
	...
	public void generate(HttpServletResponse response, List<CitizenPlan> plans, File f) throws Exception {
		...
		// these two lines are used to include one pdf into another pdf
		...
		for (CitizenPlan plan : plans) {
			...
			table.addCell(plan.getPlanStartDate() + ""); // by concatinating the date will be considered as a string(in
